    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_10px_40px_-12px_rgba(15,40,80,0.15)] sm:p-6">
          <label className="text-xs font-semibold uppercase tracking-wide text-[#6b7280]">Your portal link or code</label>
          <div className="mt-2 flex gap-2">
            <input
              ...
              className="min-w-0 flex-1 rounded-lg border border-slate-300 bg-white px-3 py-3 text-sm text-slate-900 placeholder:text-[#6b7280] shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
            />
            <button
              onClick={open}
          ...
          <div className="mt-5 rounded-lg border border-slate-200 bg-slate-50 p-3 text-xs text-[#6b7280]">
