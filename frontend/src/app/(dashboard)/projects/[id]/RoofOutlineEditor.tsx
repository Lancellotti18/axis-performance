    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col md:flex-row min-h-0">
          ...
          {/* ── Sidebar ──────────────────────────────────────────── */}
          <div
            className="md:w-[300px] md:border-l border-t md:border-t-0 border-white/10 bg-slate-50 flex flex-col gap-3 p-4 flex-shrink-0 overflow-y-auto"
            style={{ maxHeight: '100%' }}
          >
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-white rounded-lg p-2.5 border border-white/10">
            ...
            {notes && (
              <div className="text-[11px] text-slate-600 bg-white rounded-lg p-2 border border-white/10 leading-relaxed">
                {notes}
              </div>
            )}
            ...
            <div className="flex flex-col gap-2 mt-auto">
              <button
                onClick={redetect}
                disabled={detecting}
                className="px-3 py-2 rounded-lg text-xs font-semibold text-slate-700 bg-white border border-white/15 hover:bg-slate-100 disabled:opacity-50"
              >
