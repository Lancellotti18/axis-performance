...
export default function RoofOutlineEditor({
  ...
  return (
    ...
    >
      ...
      >
        {/* ── Header ───────────────────────────────────────────────── */}
        <div className="flex items-center justify-between px-5 py-3 border-b border-[#dededc] flex-shrink-0">
          <div>
          ...
          <button
            onClick={onClose}
            className="text-[#6b7280] hover:text-slate-700 text-2xl leading-none w-8 h-8 flex items-center justify-center rounded-full hover:bg-slate-100"
            aria-label="Close"
          >
            ×
          </button>
        ...
        <div className="flex-1 flex flex-col md:flex-row min-h-0">
          ...
          <div
            ref={viewportRef}
            className="relative flex-1 bg-[#f8f8f7] overflow-hidden select-none"
            style={{
          ...
          >
            ...
            >
              <button
                ...
                className="w-8 h-8 rounded-md flex items-center justify-center text-[#1a1a1a] font-bold text-lg hover:bg-white/15 transition-all"
                title="Zoom in"
              >+</button>
              <span className="text-[#2d2d2d] text-xs tabular-nums px-1 min-w-[44px] text-center font-semibold">
              ...
              <button
                ...
                className="px-2.5 h-8 rounded-md text-[#1a1a1a] hover:text-[#1a1a1a] hover:bg-white/15 transition-all text-xs font-semibold disabled:opacity-40 disabled:cursor-not-allowed"
              ...
              <button
                ...
                className="px-2.5 h-8 rounded-md text-[#1a1a1a] hover:text-[#1a1a1a] hover:bg-white/15 transition-all text-xs font-semibold"
            ...
            {polygon.length > 0 && (
              <div
                ...
                onMouseDown={e => e.stopPropagation()}
              >
                <div className="text-[10px] font-bold text-[#2d2d2d] uppercase tracking-wider text-center pt-0.5">
                  Corners
                </div>
                <div className="text-[#1a1a1a] text-2xl font-bold text-center tabular-nums leading-none py-0.5">
                  {polygon.length}
                </div>
                <div className="w-full h-px bg-[#eeeeed] my-0.5" />
                <button
                  onClick={addDetail}
                  disabled={polygon.length >= 24}
                  className="px-2 h-8 rounded-md flex items-center justify-center gap-1.5 bg-blue-600 hover:bg-blue-500 disabled:bg-[#e4e4e2] disabled:opacity-40 disabled:cursor-not-allowed text-white text-xs font-semibold transition-all"
                ...
                <button
                  ...
                  className="px-2 h-8 rounded-md flex items-center justify-center gap-1.5 bg-[#e4e4e2] hover:bg-[#d4d4d2] disabled:opacity-40 disabled:cursor-not-allowed text-[#1a1a1a] text-xs font-semibold transition-all"
            ...
            {detecting && (
              <div className="absolute inset-0 flex items-center justify-center bg-[#f8f8f7] text-blue-200 text-sm font-semibold pointer-events-none">
            ...
            {!detecting && polygon.length === 0 && !error && (
              <div className="absolute inset-0 flex items-center justify-center text-[#2d2d2d] text-xs pointer-events-none">
          ...
          {/* ── Sidebar ──────────────────────────────────────────── */}
          <div
            className="md:w-[300px] md:border-l border-t md:border-t-0 border-[#dededc] bg-slate-50 flex flex-col gap-3 p-4 flex-shrink-0 overflow-y-auto"
            style={{ maxHeight: '100%' }}
          >
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-white rounded-lg p-2.5 border border-[#dededc]">
                <div className="text-[10px] uppercase tracking-wider text-[#6b7280] font-semibold">Roof area</div>
                <div className="text-2xl font-black text-slate-900 tabular-nums leading-none mt-1">
                  {stats.sqft != null ? stats.sqft.toLocaleString() : '—'}
                </div>
                <div className="text-[10px] text-[#6b7280] mt-0.5">sqft</div>
              </div>
              <div className="bg-white rounded-lg p-2.5 border border-[#dededc]">
                <div className="text-[10px] uppercase tracking-wider text-[#6b7280] font-semibold">Perimeter</div>
                <div className="text-2xl font-black text-slate-900 tabular-nums leading-none mt-1">
                  {stats.perimeter != null ? stats.perimeter.toLocaleString() : '—'}
                </div>
                <div className="text-[10px] text-[#6b7280] mt-0.5">ft</div>
              </div>
            </div>
            ...
            {notes && (
              <div className="text-[11px] text-[#9ca3af] bg-white rounded-lg p-2 border border-[#dededc] leading-relaxed">
                {notes}
              </div>
            )}
            ...
            <div className="flex flex-col gap-2 mt-auto">
              <button
                onClick={redetect}
                disabled={detecting}
                className="px-3 py-2 rounded-lg text-xs font-semibold text-slate-700 bg-white border border-[#dededc] hover:bg-slate-100 disabled:opacity-50"
              >
              ...
              <button
                ...
                className="px-3 py-2.5 rounded-lg text-sm font-bold text-[#1a1a1a] shadow-sm disabled:opacity-50"
                style={{
                  background:
