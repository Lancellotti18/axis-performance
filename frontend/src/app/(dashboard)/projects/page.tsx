        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Filter projects…" className="bg-white/[0.06] border border-white/12 rounded-lg pl-8 pr-3 py-1.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-blue-400/40 w-48" />
            </div>
            <div className="flex bg-white/[0.06] border border-white/12 rounded-lg overflow-hidden">
