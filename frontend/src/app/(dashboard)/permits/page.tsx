...
function LoadingCard() {
  return (
    <div className="bg-[#f8f8f7] rounded-2xl p-10 flex items-center justify-center" style={{ boxShadow: '0 8px 32px rgba(0,0,0,0.30)', border: '1px solid rgba(255,255,255,0.10)' }}>
  ...
  return (
    <div className="relative min-h-full" style={{ background: 'var(--color-surface-1)' }}>
      ...
      <div className="mb-8">
        ...
        <p className="text-[#6b7280] text-sm mt-1">Auto-fetch the official form for your jurisdiction, fill it from your uploads, and download a completed PDF.</p>
      </div>
      ...
      {!ready ? (
        ...
        <div className="space-y-5">
          {/* Project selector */}
          <div className="bg-[#f8f8f7] rounded-2xl p-6 space-y-3" style={cardStyle}>
            <label className="text-[#1a1a1a] font-semibold text-sm block">Project</label>
            {projectsLoading ? (
              <div className="h-10 bg-[#f8f8f7] rounded-xl animate-pulse" />
            ) : projects.length === 0 ? (
              <div className="text-center py-6">
                <p className="text-[#6b7280] text-sm mb-3">No projects yet. Measure a roof or upload a blueprint to get started.</p>
                <button
