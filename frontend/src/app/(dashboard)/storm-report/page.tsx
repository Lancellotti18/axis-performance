  ...
  return (
    <div className="min-h-screen p-6 md:p-8" style={{ background: '#040810' }}>
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* Error */}
        {error && !loading && (
          <div className="bg-rose-500/10 border border-red-200 rounded-2xl p-4 text-red-600 text-sm">{error}</div>
        )}
              ...
              <div className="bg-white/[0.04] rounded-2xl px-5 py-4" style={cardStyle}>
                ...
                <div className="space-y-3">
                  {recs.map((r, i) => {
                    ...
                    return (
                      <div key={i} className="border rounded-xl p-3" style={{ borderColor: 'rgba(255,255,255,0.10)' }}>
