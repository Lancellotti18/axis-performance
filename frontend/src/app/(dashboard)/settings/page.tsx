        ...
        <div className="space-y-5">
          ...
          <div className={card}>
            ...
            <div className="mb-5 flex items-center gap-4">
              <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-[#dededc] bg-[#f8f8f7]">
                {profile.logo_url
                  // eslint-disable-next-line @next/next/no-img-element
                  ? <img src={profile.logo_url} alt="Company logo" className="max-h-full max-w-full object-contain" />
                  : <span className="text-[10px] text-[#6b7280]">No logo</span>}
              </div>
              <div>
                ...
                <p className="mt-1.5 text-[11px] text-[#6b7280]">PNG or JPG. Axis trims and centers it automatically.</p>
              </div>
            </div>
            ...
            <button onClick={save} disabled={saving}
              className="mt-6 text-[#1a1a1a] font-semibold px-5 py-2.5 rounded-xl text-sm transition-all hover:scale-[1.02] disabled:opacity-60 disabled:hover:scale-100" style={blueBtn}>
